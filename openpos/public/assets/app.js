...
const I18N = {
  en: {
    ...
    no_open_shift: 'No shift open — the till opens one',
    date: 'Date', served_by: 'Served by', change: 'Change', points: 'Points',
    offline_queued: 'Sale queued — no internet right now',
    pick_customer: 'Choose a customer first',
    offline_sync_note: 'Kept on this till; it syncs itself when the internet returns',
    thank_you: 'Thank you',
    tf_draft: 'Draft', tf_scheduled: 'Scheduled',
    confirmed: 'Confirmed', suspended: 'Held', voided: 'Voided', draft: 'Draft',
    credit: 'Credit', bank: 'Bank',
  ...
  sw: {
    ...
    no_open_shift: 'Hakuna zamu wazi — taa inafungua moja',
    date: 'Tarehe', served_by: 'Aliyekuhudumia', change: 'Chenji', points: 'Pointi',
    offline_queued: 'Muamala umepangwa foleni — hakuna mtandao sasa',
    pick_customer: 'Chagua mteja kwanza',
    offline_sync_note: 'Umehifadhiwa kwenye taa hii; utasawazishwa mtandao ukirudi',
    thank_you: 'Asante',
    tf_draft: 'Rasimu', tf_scheduled: 'Imeratibiwa',
    confirmed: 'Imethibitishwa', suspended: 'Imewekwa', voided: 'Imefutwa', draft: 'Rasimu',
    credit: 'Deni', bank: 'Benki',
