...
const I18N = {
  en: {
    ...
    step_business: 'Business', step_tax: 'Tax & KRA', step_branch: 'First branch', step_owner: 'Owner',
    ...
    till: 'Till', reports: 'Reports', logout: 'Sign out', online: 'Online',
  ...
  sw: {
    ...
    step_business: 'Biashara', step_tax: 'Kodi & KRA', step_branch: 'Shamba la kwanza', step_owner: 'Mmiliki',
    ...
    till: 'Taa', reports: 'Ripoti', logout: 'Toka', online: 'Mtandaoni',
