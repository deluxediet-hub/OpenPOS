...
/* -------------------------------- receipt --------------------------------- */
function buildReceipt(r, { paid = true, partial = false } = {}) {
  ...
  d.feed(1).bold(true).ln(paid ? 'SALES RECEIPT - PAID' : partial ? 'PART PAYMENT - BALANCE DUE' : 'SALE SUMMARY - UNPAID').bold(false).align('left');
